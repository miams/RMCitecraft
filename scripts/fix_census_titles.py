...
TITLE_FIXES = {
    1870: {
        'bibliography': [
            # &quot; format - handle period outside quotes first to avoid double period
            TitleFix('&quot;United States Census, 1870&quot;.', '&quot;United States, Census, 1870.&quot;'),
            TitleFix('&quot;United States Census, 1870&quot;', '&quot;United States, Census, 1870.&quot;'),
            TitleFix('&quot;United States Census, 1870.&quot;', '&quot;United States, Census, 1870.&quot;'),
            TitleFix('&quot;1870 United States Federal Census.&quot;', '&quot;United States, Census, 1870.&quot;'),
            TitleFix('&quot;1870 United States Federal Census&quot;', '&quot;United States, Census, 1870.&quot;'),
            # Regular quote format - handle period outside quotes first
            TitleFix('"United States Census, 1870".', '"United States, Census, 1870."'),
            TitleFix('"United States Census, 1870"', '"United States, Census, 1870."'),
            TitleFix('"United States Census, 1870."', '"United States, Census, 1870."'),
            TitleFix('"1870 United States Federal Census."', '"United States, Census, 1870."'),
    ...
    1920: {
        'bibliography': [
            # &quot; format - handle period outside quotes first to avoid double period
            TitleFix('&quot;United States Census, 1920&quot;.', '&quot;United States, Census, 1920.&quot;'),
            TitleFix('&quot;United States Census, 1920&quot;', '&quot;United States, Census, 1920.&quot;'),
            TitleFix('&quot;United States Census, 1920.&quot;', '&quot;United States, Census, 1920.&quot;'),
            TitleFix('&quot;1920 United States Federal Census.&quot;', '&quot;United States, Census, 1920.&quot;'),
            TitleFix('&quot;1920 United States Federal Census&quot;', '&quot;United States, Census, 1920.&quot;'),
            # Regular quote format - handle period outside quotes first
            TitleFix('"United States Census, 1920".', '"United States, Census, 1920."'),
            TitleFix('"United States Census, 1920"', '"United States, Census, 1920."'),
...
def main():
    ...
    parser.add_argument(
        '--year',
        type=int,
        choices=[1870, 1920, 1930, 1940, 1950],
    ...
    years = [args.year] if args.year else [1870, 1920, 1930, 1940, 1950]
